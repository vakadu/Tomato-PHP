        ...
        <div class="container">
            <div class="col-md-12">
                <div class="home__container wow animated fadeIn" data-wow-duration="1s" data-wow-delay=".5s"><!--Start Content Container-->
                    ...
                    <div class="home__boxes"><!--start home boxes-->
                        <div class="col-md-4">
                            <div class="home__boxes--item home__boxes--item1">
                                <svg class="svg-icon" width="512" height="512" viewbox="0 0 20 20">
                                    <g fill="#FFFFFF">
                                ...
                                <h4><span>1. </span>search for restaurant / events</h4>
                            </div><!--end home__boxes--item-->
                        </div><!--end column-->
                        <div class="col-md-4">
                            <div class="home__boxes--item home__boxes--item2">
                                <svg class="svg-icon" width="512" height="512" viewBox="0 0 20 20">
                                    <g fill="#FFFFFF">
                                ...
                                <h4><span>2. </span>view restaurant menu / events</h4>
                            </div><!--end home__boxes--item-->
                        </div><!--end column-->
                        <div class="col-md-4">
                            <div class="home__boxes--item home__boxes--item3">
                                <svg class="svg-icon" width="512" height="512" viewBox="0 0 20 20">
                                    <g fill="#FFFFFF">
                                ...
                                <h4><span>3. </span>make a reservation</h4>
                            </div><!--end home__boxes--item-->
                        </div><!--end column-->
                    </div><!--end home boxes-->
